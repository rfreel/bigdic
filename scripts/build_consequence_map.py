...
<div class="note"><strong>One useful composition:</strong> claim → live rival → incompatible prediction → severe test → scoped disposition or unresolved branch → reopen predicate. Choose another route when this sequence cannot change the required result. <a href="consequence-system.md">See the admission rules.</a></div></main><script>
...
page = (page.replace('__COUNT__', str(counts['frontier_positions']))
        ...
        .replace('__DOMAINS__', domain_sections))
